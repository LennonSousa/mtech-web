...
const EditStore: NextPage = () => {
    ...
    const [imagePreview, setImagePreview] = useState('/assets/images/logo.jpg');
    ...
    return (
        <>
            <NextSeo
                title="Criar loja"
                description="Criar loja da plataforma de gerenciamento da Plataforma solar."
                openGraph={{
                    ...
                    images: [
                        {
                            ...
                            alt: 'Criar loja | Plataforma solar',
                        },
                        { url: `${process.env.NEXT_PUBLIC_API_URL}/assets/images/logo.jpg` },
                    ],
                }}
...

            {
                !user || loading ? <PageWaiting status="waiting" /> :
                    <>
                        {
                            can(user, "store", "update:any") ? <Container className="content-page">
                                <Row className="mb-3">
                                    <Col>
                                ...
                                <Formik
                                    ...
                                    onSubmit={async values => {
                                        ...
                                        try {
                                            ...
                                            dataToSave.append('avatar', imageSelected);
                                                ...
                                                <Col md={6} sm={4}>
                                                    <Form.Group controlId="procuctImageFile" className="mb-3">
                                                        ...
                                                        <Form.Control
                                                            ...
                                                            isInvalid={!imageSelected && touched.title}
                                                        />
                                                        {
                                                            !imageSelected && touched.title &&
                                                            <label className="invalid-feedback" style={{ display: 'block' }}>Obrigatório!</label>
                                                        }
                                                    </Form.Group>
                                                </Col>
                                            </Row>
